...
./clamr_cpuonly -n 1024 -t 500 -i 100 -l 2 -A "cell"                   >& origcellrun.out
./clamr_cpuonly -n 1024 -t 500 -i 100 -l 2 -A "face"                   >& origfacerun.out
./clamr_cpuonly -n 1024 -t 500 -i 100 -l 2 -A "cell-in-place"          >& cellinplacerun.out
./clamr_cpuonly -n 1024 -t 500 -i 100 -l 2 -A "face-in-place"          >& faceinplacerun.out
./clamr_cpuonly -n 1024 -t 500 -i 100 -l 2 -A "regular-grid"           >& reggridbycellrun.out
./clamr_cpuonly -n 1024 -t 500 -i 100 -l 2 -A "regular-grid-by-faces"  >& reggridbyfacesrun.out
