# -*- coding: utf-8 -*-
#
# MallocPlus documentation build configuration file, created by
...
htmlhelp_basename = 'MallocPlusdoc'
...
man_pages = [
    ('index', 'mallocplus', u'MallocPlus Documentation',
     [u'Bob Robey'], 1)
]
...
texinfo_documents = [
  ('index', 'MallocPlus', u'MallocPlus Documentation',
   u'Bob Robey', 'MallocPlus', 'One line description of project.',
   'Miscellaneous'),
]
